...
conn.execute("""CREATE TABLE IF NOT EXISTS PARKING (REG INT PRIMARY KEY NOT NULL,NAME TEXT NOT NULL,HOSTEL CHAR(5) NOT NULL,SEX CHAR(8) NOT NULL,
MOBILE CHAR(12) NOT NULL,EMAIL CHAR(50) NOT NULL,USERNAME CHAR(50) NOT NULL,PASSWORD CHAR(50) NOT NULL,VEHICLE CHAR(15),PARK CHAR(10), TYPE CHAR(12) ,P CHAR(2))""")
conn.commit()
conn.close()
...
def Base_Page():
    ...
    PMS=Label(root,text="Parking Management System",font=("Helvetica", 40),bg='#6ed3cf',padx=20,pady=20)
    logo.grid(row=1,column=0)
    PMS.grid(row=1,column=1,columnspan=2)
    
    icon1=PhotoImage(file="Login.png")
    Log=Label(root,image=icon1)
    Login_Button=Button(root,text="Login",font=("Times New Roman",18),bd=3,command=Login_Page,bg='tomato',activebackground='#9068be')

    icon2=PhotoImage(file="NewUser.png")
    NUsr=Label(root,image=icon2)
    NewUser_Button=Button(root,text="New User",font=("Times New Roman",18),bd=3,command=BptoNu,bg='tomato',activebackground='#9068be')
    icon3=PhotoImage(file="Availability.png")
    Avai=Label(root,image=icon3)
    Availability_Button=Button(root,text="Availability",font=("Times New Roman",18),bd=3,command=Availability,bg='tomato',activebackground='#9068be')
    Log.grid(row=2)
...
def Login_Page():
    ...
    PMS=Label(Login_GUI,text="Parking Management System",font=("Helvetica", 40),bg='#6ed3cf',padx=20,pady=20)
    logo.grid(row=1,column=0)
    ...
    Login_Button=Button(Login_GUI,text=" Login  ",command=validate,font=("Times New Roman",32),bg='tomato',activebackground='#9068be')
    NewUser_Button=Button(Login_GUI,text="New User",command=LptoNu,font=("Times New Roman",32),bg='tomato',activebackground='#9068be')
...
def NewUser_Page():
    ...
    PMS=Label(NewUser_GUI,text="Parking Management System",font=("Helvetica", 40),bg='#6ed3cf',padx=20,pady=20)
    logo.grid(row=1,column=0)
    PMS.grid(row=1,column=1,columnspan=3)
    
    lab1=Label(NewUser_GUI,text="Name",padx=10,pady=5,font=("Times New Roman",18))
    lab2=Label(NewUser_GUI,text="Reg. No.",padx=10,pady=5,font=("Times New Roman",18))
    lab3=Label(NewUser_GUI,text="Hostel",padx=10,pady=5,font=("Times New Roman",18))
    lab4=Label(NewUser_GUI,text="Gender",padx=10,pady=5,font=("Times New Roman",18))
    lab5=Label(NewUser_GUI,text="Mobile",padx=10,pady=5,font=("Times New Roman",18))
    lab6=Label(NewUser_GUI,text="Email ID",padx=10,pady=5,font=("Times New Roman",18))
    lab7=Label(NewUser_GUI,text="User Name",padx=10,pady=5,font=("Times New Roman",18))
    lab8=Label(NewUser_GUI,text="Password",padx=10,pady=5,font=("Times New Roman",18))
    global Name
    global Register
    global Hostel
    global Mobile
    ...
    lab10.grid(row=10)
    Submit_Button=Button(NewUser_GUI,text="Submit",command=DB_Reg,font=("Times New Roman",25),bd=3,bg='tomato',activebackground='#9068be')
...
def User_Page():
    ...
    PMS=Label(User_GUI,text="Parking Management System",font=("Helvetica", 40),bg='#6ed3cf',padx=20,pady=20)
    logo.grid(row=1,column=0)
    PMS.grid(row=1,column=1,columnspan=3)
